...
crs_proj = CRS(
    "EPSG:24821")  # Please provide proper projection system based on the geographical location of the selected country.
...
shp_nm = "gadm41_{}_1.shp".format(country_name)
...
print((' **Based on 3-letter naming, additional crop list from the FAOSTAT is :** {}'.format(other_crop_name)))
